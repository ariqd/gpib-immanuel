<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" id="header_navigation">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.worships.index')" :active="request()->routeIs('admin.worships*')">
                {{ __('Ibadah') }}
            ...
            <x-responsive-nav-link :href="route('admin.carousel.index')" :active="request()->routeIs('admin.carousel*')">
                {{ __('Carousel') }}
            </x-responsive-nav-link>
        </div>
